...
ret, camera_matrix, camera_matrix_optimal, distortion_coefficients, _, _, _, _ = calibration.calibrate_with_charuco(calibration_images, charuco_board, 1)

calibration.save_single_cam_params(params_file, camera_matrix, camera_matrix_optimal, distortion_coefficients)
