...
camera_mat_1_optimal, roi_1 = cv.getOptimalNewCameraMatrix(camera_mat_1, dist_coeff_1, image_size, 1, image_size)
camera_mat_2_optimal, roi_2 = cv.getOptimalNewCameraMatrix(camera_mat_2, dist_coeff_2, image_size, 1, image_size)
...
reconstruction.write_ply(Path('/home/watermelon0guy/Code/Python/cv_reconstruct/res/membrane_exp/flat.ply'), points_3d, colors)
